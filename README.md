...
## إضافات الكتالوج الحالية

- مؤقت ترند اختياري بالثواني أو الدقائق مع وقت بدء/انتهاء.
- نص مخصص داخل الترند مع لون خط ولون خلفية.
- فئات جانبية مستقلة مرتبطة بالمستويات الرئيسية فقط، ولكل فئة دوائر مصورة مستقلة.
- Product Wizard يدعم ربط المنتج بدوائر الفئات الجانبية.
- تفاصيل إضافية: `docs/ADMIN_COMPLETION_AR.md` و`docs/API_CONTRACT_AR.md`.
